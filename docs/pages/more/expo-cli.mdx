...
| `EXPO_USE_FAST_RESOLVER`             | **boolean** | <div className="flex items-center pb-1.5"><StatusTag status="SDK 51+" /></div>Enable an alternative module resolver for Metro. This may behave differently in some cases.                                                                                                                                                                                                                                                       |
...
| `EXPO_NO_REACT_NATIVE_WEB`           | **boolean** | <div className="flex items-center pb-1.5"><StatusTag status="experimental" /><StatusTag status="SDK 52+" /></div>Enable experimental mode where React Native Web isn't required to runj Expo apps on web.                                                                                                                                                                                                                        |
